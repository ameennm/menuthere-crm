    ...
    <div className="modal-overlay" onClick={onClose}>
      ...
      >
        ...
        <div
          style={{
            background:
              "linear-gradient(135deg, var(--accent-primary) 0%, #4f3bdb 100%)",
              ...
              >
                ...
                <span
                  style={{
                    ...
                    borderRadius: 20,
                    fontWeight: 600,
                    ...PAYMENT_STYLE[customer.paymentStatus],
                  }}
                >
        ...
        <div style={{ padding: "4px 20px 8px" }}>
          ...
          <Row
            ...
            value={
              RESTAURANT_LABELS[customer.restaurantType] ||
          ...
          <Row
            icon={Calendar}
            label="Next Call"
            value={formatDateTime(customer.nextCallDate)}
          />
          <Row icon={FileText} label="Call Notes" value={customer.callNotes} />
          {customer.status === "not-interested" && (
            <Row
              icon={AlertCircle}
              label="Reason Not Interested"
              value={customer.notInterestedReason}
